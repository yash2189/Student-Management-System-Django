...
class student(models.Model):
	...
	#academic
	current_cgpa=models.DecimalField(max_digits=10,decimal_places=7,null=False,blank=False)
	avg_cgpa=models.DecimalField(max_digits=10,decimal_places=7,null=False,blank=False)
	ssc_marks=models.DecimalField(max_digits=10,decimal_places=7,null=False,blank=False)
	hsc_marks=models.DecimalField(max_digits=10,decimal_places=7,null=False,blank=False)
